# Dataframe: `CORN:expected_return_predictions` - Expected Return Strategy Predictions
...
$ target_log_return_next <f64> -0.004308026097975315
$ predicted_return       <f64> 0.000561684593954078
$ train_start            <str> '2011-01-07'
$ train_end              <str> '2026-03-27'
$ n_train                <i64> 795
$ trade_threshold        <f64> 0.003
$ position               <f64> 0.0
$ turnover               <f64> 0.0
$ transaction_cost       <f64> 0.0
$ strategy_log_return    <f64> -0.0
$ benchmark_log_return   <f64> -0.004308026097975315
$ cum_strategy_return    <f64> 0.03321570405766949
$ cum_benchmark_return   <f64> -0.2853837073443145
...
| Dataframe Name                 | Expected Return Strategy Predictions                                                   |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [expected_return_predictions](../dataframes/CORN/expected_return_predictions.md)                                       |
| Data Sources                   | Generated model output                                        |
| Data Providers                 | corn_forecast.expected_return_strategy                                      |
| Links to Providers             |                              |
| Topic Tags                     | Expected Return, Strategy, Corn                                          |
| Type of Data Access            |                                   |
| How is data pulled?            | Generated by doit return_strategy.                                                    |
| Data available up to (min)     | None                                                             |
| Data available up to (max)     | None                                                             |
| Dataframe Path                 | /Users/Haruki/Library/Mobile Documents/com~apple~CloudDocs/Python/AIF/final/FINM_33200_Group_8/reports/expected_return_predictions.csv                                                   |
