# Dataframe: `CORN:price_target_predictions` - Fixed Threshold Classification Predictions
...
$ week                   <str> '2026-05-08'
$ fold                   <i64> 13
$ experiment             <str> 'three_class_fixed'
$ feature_set            <str> 'price_only'
$ model                  <str> 'price_only_logit'
$ y_true_return          <f64> null
$ y_pred_return          <f64> null
$ train_start            <str> '2011-01-07'
$ train_end              <str> '2026-03-27'
$ n_train                <i64> 795
$ y_true_3class          <str> '0.0'
$ y_pred_3class          <str> '1.0'
$ target_log_return_next <str> '-0.004308026097975315'
...
| Dataframe Name                 | Fixed Threshold Classification Predictions                                                   |
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [price_target_predictions](../dataframes/CORN/price_target_predictions.md)                                       |
| Data Sources                   | Generated model output                                        |
| Data Providers                 | corn_forecast.price_target_tests                                      |
| Links to Providers             |                              |
| Topic Tags                     | Classification, Walk Forward, Corn                                          |
| Type of Data Access            |                                   |
| How is data pulled?            | Generated by doit classify_move.                                                    |
| Data available up to (min)     | None                                                             |
| Data available up to (max)     | None                                                             |
| Dataframe Path                 | /Users/Haruki/Library/Mobile Documents/com~apple~CloudDocs/Python/AIF/final/FINM_33200_Group_8/reports/price_target_predictions.csv                                                   |
