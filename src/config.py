...
class ProjectConfig:
    ...
    def price_target_metrics_path(self) -> Path:
        return self.reports_dir / "price_target_tests.json"

    @property
    def price_target_predictions_path(self) -> Path:
        return self.reports_dir / "price_target_predictions.csv"

    @property
    def threshold_metrics_path(self) -> Path:
        return self.reports_dir / "threshold_selection.json"

    @property
    def threshold_predictions_path(self) -> Path:
        return self.reports_dir / "threshold_selection_predictions.csv"

    @property
    def expected_return_metrics_path(self) -> Path:
        return self.reports_dir / "expected_return_metrics.json"

    @property
    def expected_return_predictions_path(self) -> Path:
        return self.reports_dir / "expected_return_predictions.csv"

    @property
    def volatility_metrics_path(self) -> Path:
        return self.reports_dir / "volatility_metrics.json"

    @property
    def volatility_predictions_path(self) -> Path:
        return self.reports_dir / "volatility_predictions.csv"
