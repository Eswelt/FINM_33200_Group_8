#!/usr/bin/env python3
"""
Download CFSv2 operational 00Z forecasts and build daily-init regional statistic NetCDF files.
...
def process_year(year: int, init_dates: list[dt.date], args: argparse.Namespace) -> None:
    ...
    for i, init in enumerate(init_times):
        ...
        print(
            ...
            f"({i + 1}/{len(init_times)}); extracted={extracted}; missing={missing}; skipped={skipped}"
        )
